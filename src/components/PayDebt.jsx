            ...
            <article>
                ...
                {data.length > 0 ?
                    <ul className="leading-10">
                        ...
                        <li className="font-bold text-xl p-3 mt-3 bg-slate-200 rounded-md"><span className="block mb-3">Importe:</span> {data[0].monto_deuda_final}</li>
                    </ul>: <Loader/>
                }
            </article>
            <button className="btn btn-primary"><Link to={`/pay/${id}/finished`}>Pagar Deuda</Link></button>
        </div>
    )
}
